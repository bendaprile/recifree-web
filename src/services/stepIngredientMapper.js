/**
 * Step-Ingredient Mapper Utility (Client-Side)
 ...
 */
export function cleanItemNameForMatching(item) {
  if (!item) return '';
 ...
 */
export function mapStepsToIngredients(instructions, flatIngredients) {
